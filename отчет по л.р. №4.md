...
<br>
<p> Вывод: в ходе работы были приобретены навыки по работе с tailwind и улучшение навыков работы с CSS. Также была изучена теоритическая информация про язык программирования - JavaScript.</p>
<br>
